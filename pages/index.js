      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-30 xl:text-left h-full container mx-auto">
          ...
          <motion.p
            ...
            animate="show"
            exit="hidden"
            className="max-w-sm text-xs xl:text-base xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16"
          >
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque
            maiores libero deleniti facilis porro recusandae nemo tempora eos
            expedita repellat. Accusamus labore excepturi at ex.
          </motion.p>
